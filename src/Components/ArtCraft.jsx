          ...
          <div className="flex justify-end">
            <Link to={`/artcraftmatch/${art.name}`}>
              <button className="relative inline-flex items-center justify-center p-4 px-2 md:px-6 py-1 md:py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-red-300 rounded-full shadow-md group">
                ...
                <span className="absolute text-[14px] md:text-xl flex items-center justify-center w-full h-full text-purple-500 transition-all duration-300 transform group-hover:translate-x-full ease">View All Related Data</span>
                <span className="relative invisible">View All Related Data</span>
              </button>
            </Link>
          </div>
