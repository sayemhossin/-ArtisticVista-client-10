        ...
        <div>
          {
            ...
            <svg aria-hidden="true" className="inline text-4xl ml-[50%] mb-[40%] mt-[10%] w-10 h-10 text-gray-200 animate-spin dark:text-black fill-red-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
