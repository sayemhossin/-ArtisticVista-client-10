    ...
    return (
        <div>
            {loading ? (
                ...
                <details className="dropdown grid mx-[20%] md:mx-[30%] lg:mx-[35%] justify-center rounded-xl mt-11 bg-red-900" onClick={() => setArr(!arr)}>
                    <summary className="m-1  btn border-0 md:text-xl text-gray-200  hover:bg-red-800 bg-red-900">Filter By Customization {arr ? <FaArrowUp /> : <FaArrowDown />}
                    ...
                    <ul className="p-2 text-xl font-bold shadow menu dropdown-content z-[1]  bg-red-100 rounded-box w-52">
